...
#     # Reference: 
#     # https://github.com/cdt15/lingam/blob/2990b726d475b52588e4edafed10e6cae57f03a4/lingam/causal_effect.py#L81C9-L81C9
#     # https://github.com/cdt15/lingam/blob/2990b726d475b52588e4edafed10e6cae57f03a4/lingam/causal_effect.py#L133
...
def causal_prediction(
    ...
    sim.train(all_df, lg_model._adjacency_matrix)
